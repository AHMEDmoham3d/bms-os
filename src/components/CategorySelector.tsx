          ...
          return (
            <div key={category.id} className="relative">
              ...
              <button
                ...
                className="absolute -top-3 left-1/2 -translate-x-1/2 bg-emerald-500 hover:bg-emerald-600 text-white p-2 rounded-full shadow-lg hover:shadow-xl transition-all w-10 h-10 flex items-center justify-center"
              >
                <Plus className="w-4 h-4" />
              </button>
            </div>
