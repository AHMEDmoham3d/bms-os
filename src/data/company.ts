...
export const products: Product[] = [
  ...
  },
  {
    id: 'edumanage',
    sector_id: 'education',
    name: 'Education centers management system',
    description:
      'Advanced educational center management platform with integrated LMS, comprehensive system for managing student enrollment, class scheduling, attendance tracking, instructor management, performance analytics, and parent-student communication',
    ...
    planUrl: 'https://ahmedmoham3d.github.io/sowft-ware-ws1/',
    launch_date: '2026-03-21',
  },
  {
    id: 'Academix',
    sector_id: 'education',
    name: 'Academix(university-school management system)',
    description: 'Advanced college and university management platform with LMS integration, Comprehensive school management system covering admissions, academics, attendance, and parent communication',
    status: 'planned' as const,
...
export const teamMembers = [
  {
    ...
    role: 'CEO & Founder',
    sector_id: null,
    email: '7hmedmohamed12@gmail.com',
    joined_date: '2023-06-01',
    bio: 'Serial entrepreneur with 5 years in enterprise software',
  },
  {
    id: '2',
    name: 'Robert Kim',
