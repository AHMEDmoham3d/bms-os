...
function NotesPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-8 py-16 lg:px-12">
      <div className="bg-white border border-slate-200 rounded-3xl p-12 lg:p-16 shadow-2xl mb-16 mx-4 lg:mx-0">
        <div className="max-w-6xl mx-auto space-y-16 px-4 lg:px-0">
          ...
          <section className="space-y-8">
            {/* Stats Bar */}
            <div className="bg-gradient-to-br from-slate-50/80 via-white to-slate-50/50 backdrop-blur-xl p-8 lg:p-12 rounded-3xl border border-slate-200/30 shadow-2xl hover:shadow-3xl transition-all duration-500 mx-4 lg:mx-0">
              <div className="flex flex-col lg:flex-row gap-8 items-center justify-center text-center lg:text-left max-w-4xl mx-auto px-4 lg:px-0">
                <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-slate-900/5 to-slate-800/5 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 group">
                  <div className="w-14 h-14 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl group-hover:scale-105 transition-all duration-300 flex-shrink-0">
                    <FolderOpen className="w-7 h-7 text-white" />
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-slate-600 uppercase tracking-wider group-hover:text-slate-800 transition-colors">Categories</p>
                    <p className="text-4xl lg:text-3xl xl:text-4xl font-black bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent drop-shadow-lg">{categories.length}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-emerald-500/10 via-emerald-400/10 to-emerald-600/5 backdrop-blur-sm rounded-2xl border border-emerald-200/50 shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all duration-300 group">
                  ...
                  <div>
                    ...
                    <p className="text-4xl lg:text-3xl xl:text-4xl font-black bg-gradient-to-r from-emerald-600 to-emerald-400 bg-clip-text text-transparent drop-shadow-2xl">{totalNotes}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <section>
              <div className="flex flex-col lg:flex-row gap-8 items-start mb-12">
                <div className="bg-slate-50 p-8 rounded-xl border border-slate-200">
                  <h3 className="text-3xl font-black text-slate-900">{selectedCategory.name}</h3>
          ...
          {categories.length === 0 && (
            <div className="text-center py-32 bg-slate-50 rounded-2xl p-12 border border-slate-200">
              ...
              <h3 className="text-3xl font-bold text-slate-900 mb-4">No Categories</h3>
              <p className="text-xl text-slate-600 mb-8">
                Create categories in your Supabase dashboard first
              </p>
              <a href="https://kjrkqfwwixvapkhtssmh.supabase.co" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-slate-900 text-white px-10 py-4 rounded-2xl font-bold text-lg border border-slate-800 hover:shadow-2xl hover:-translate-y-1 transition-all shadow-xl">
                Create Categories →
              </a>
            </div>
          )}
